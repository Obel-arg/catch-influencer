...
function testMinimalRequest() {
  ...
  makeRequest('/api/method/auditor.searchSandbox/', minimalRequest, 'Minimal Request');
}
...
function testSearchRequest() {
  ...
  makeRequest('/api/method/auditor.searchSandbox/', searchRequest, 'Search Request');
}
...
function testFollowersRequest() {
  ...
  makeRequest('/api/method/auditor.searchSandbox/', followersRequest, 'Followers Request');
}
...
function testEngagementRequest() {
  ...
  makeRequest('/api/method/auditor.searchSandbox/', engagementRequest, 'Engagement Request');
}
...
function testAudienceRequest() {
  ...
  makeRequest('/api/method/auditor.searchSandbox/', audienceRequest, 'Audience Request');
}
...
function testCategoryRequest() {
  ...
  makeRequest('/api/method/auditor.searchSandbox/', categoryRequest, 'Category Request');
}
...
function testAccountTypeRequest() {
  ...
  makeRequest('/api/method/auditor.searchSandbox/', accountTypeRequest, 'Account Type Request');
}
...
function testAqsCqsRequest() {
  ...
  makeRequest('/api/method/auditor.searchSandbox/', aqsCqsRequest, 'AQS/CQS Request');
}
...
function testLocationRequest() {
  ...
  makeRequest('/api/method/auditor.searchSandbox/', locationRequest, 'Location Request');
}
...
function testSortRequest() {
  ...
  makeRequest('/api/method/auditor.searchSandbox/', sortRequest, 'Sort Request');
}
