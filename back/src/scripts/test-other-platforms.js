      ...
      try {
            ...
            if (
              ...
              response.result.search_results
                ...
                .forEach((result, index) => {
                  ...
                  console.log(
                    `     👥 Seguidores: ${
                      metrics.subscribers_count?.value?.toLocaleString() ||
                      'N/A'
                    }`,
                  );
                  console.log(
        ...
        setTimeout(() => {
          ...
          if (nextTest) {
            ...
            console.log('\n📋 RESUMEN:');
            console.log(
              '- Si algún test fue exitoso, esa plataforma está disponible',
            );
            console.log(
              '- Si todos fallan con error 8, el plan no incluye Discovery',
            );
