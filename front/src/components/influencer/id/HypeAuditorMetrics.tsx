  ...
  return (
    <div className="mt-6 space-y-8 pb-8">
      ...
      {Object.keys(prices).length > 0 && (
        <div className="bg-gradient-to-br from-purple-50 to-white rounded-2xl border border-purple-200 shadow-sm overflow-hidden">
          <button
      ...
      {Object.keys(reach).length > 0 && (
        <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-200 shadow-sm overflow-hidden">
          <button
